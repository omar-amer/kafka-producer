...
public class Album extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3680855333474619710L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Album\",\"namespace\":\"com.example.producer.model\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"year\",\"type\":\"int\"}]}");
   ...
   */
  public static com.example.producer.model.Album.Builder newBuilder() {
    return new com.example.producer.model.Album.Builder();
  }
   ...
   * @return A new Album RecordBuilder
   */
  public static com.example.producer.model.Album.Builder newBuilder(com.example.producer.model.Album.Builder other) {
    if (other == null) {
      return new com.example.producer.model.Album.Builder();
    } else {
      return new com.example.producer.model.Album.Builder(other);
    }
  }
   ...
   * @return A new Album RecordBuilder
   */
  public static com.example.producer.model.Album.Builder newBuilder(com.example.producer.model.Album other) {
    if (other == null) {
      return new com.example.producer.model.Album.Builder();
    } else {
      return new com.example.producer.model.Album.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Album>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.producer.model.Album.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.producer.model.Album other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.producer.model.Album.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.producer.model.Album.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.producer.model.Album.Builder setYear(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.producer.model.Album.Builder clearYear() {
